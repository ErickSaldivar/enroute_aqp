...
<!-- Bootstrap JS -->
    ...
    <!-- Leaflet Routing Machine (para trazar rutas de forma práctica) -->
    ...
    <script>
        ...
        if (document.getElementById('map')) {
                ...
                try {
                    ...
                    if (origenVal && !originLatLng) {
                        ...
                        if (!isInAqpBounds(originLatLng)) {
                            alert('El origen solicitado está fuera de los límites de Arequipa.');
                            return;
                        }
                    }
                    if (destinoVal && !destLatLng) {
                        ...
                        if (!isInAqpBounds(destLatLng)) {
                            alert('El destino solicitado está fuera de los límites de Arequipa.');
                            return;
                        }
                    }
                    ...
                    if (!isInAqpBounds(originLatLng) || !isInAqpBounds(destLatLng)) {
                        alert('Alguno de los puntos está fuera de los límites de Arequipa.');
                        return;
                    }
                    drawRoute();
                } catch (err) {
                    console.error('Error en buscarRuta:', err);
                    alert('Ocurrió un error buscando la ruta. Reintenta.');
                } finally {
            ...
            function drawRoute() {
                ...
                // Mostrar resumen (distancia/tiempo) cuando la ruta sea encontrada
                routeControl.on('routesfound', function(e) {
                    try {
                        if (e && e.routes && e.routes.length > 0) {
                            ...
                            // distKm se muestra como objeto y no como valor
